...
public class AlipaySignature {
  ...
  public static String rsaSign(String content, String privateKey, String charset) throws Exception {
    try {
      PrivateKey priKey =
          getPrivateKeyFromPKCS8(AlipayConstants.SIGN_TYPE_RSA,
   ...
   * /Bl1bWFN/PFCEJHWe
   * /HXj8KJKjWMO6ttsoV0xRGfeyUO8agu6t587Dl5ux5zD/s8Lbg5QXygaOwo3Fz1G8EqmGhi4+soEIQb8DBYanQOS3X
   * +m46tVqBGMw8Oe+hsyIMpsjwF4HaPKMr37zpW3fe7xOMuimbZ0wq53YP/
   ...
   * sign=rlqgA8O+RzHBVYLyHmrbODVSANWPXf3pSrr82OCO/bm3upZiXSYrX5fZr6UBmG6BZRAydEyTIguEW6VRuAKjnaO/
  ...
  public static String checkSignAndDecrypt(Map<String, String> params, String alipayPublicKey,
      String cusPrivateKey, boolean isCheckSign, boolean isDecrypt) throws Exception {
   ...
   *         <p>
   *         返回示例： <alipay> <response>密文</response> <encryption_type>RSA</encryption_type>
   *         <sign>sign</sign> <sign_type>RSA</sign_type> </alipay>
   *         </p>
   * @throws Exception
   */
  public static String encryptAndSign(String bizContent, String alipayPublicKey,
      String cusPrivateKey, String charset, boolean isEncrypt, boolean isSign) throws Exception {
  ...
  public static String rsaEncrypt(String content, String publicKey, String charset)
    ...
    try {
      PublicKey pubKey =
          getPublicKeyFromX509(AlipayConstants.SIGN_TYPE_RSA,
  ...
  public static String rsaDecrypt(String content, String privateKey, String charset)
    ...
    try {
      ...
      return StringUtils.isEmpty(charset) ? new String(decryptedData) : new String(decryptedData,
          charset);
    } catch (Exception e) {
